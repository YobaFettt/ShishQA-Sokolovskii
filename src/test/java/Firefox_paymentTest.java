...
public class Firefox_paymentTest {
    ...
    public void setUp() throws Exception {
        System.setProperty("webdriver.gecko.driver", "/home/john/Рабочий стол/ShishQA-Sokolovskii/src/test/geckodriver");
    ...
    public void testConfirmed() throws Exception {
        ...
        assertEquals("CONFIRMED", driver.findElement(By.xpath("/html/body/div/section[2]/div[1]/div[1]/div[2]")).getText());
        assertEquals(orderNumber, driver.findElement(By.xpath("/html/body/div/section[2]/div[1]/div[2]/div[2]")).getText());
